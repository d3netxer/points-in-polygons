...
This command mounts the ~/.aws directory AND set the $HOME environment variable, mounts tge code directory so that the changes are reflected live without having to rebuild the docker image, and opens the bash shell:
